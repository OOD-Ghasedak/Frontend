<template>
  <div class="channel-add-content-page">
    <BackButton />
    ...
    <div class="main-body">
      ...
      <button class="secondary-button horizontally-centered" @click="contentAction">
        <h2>{{ 'انتشار' }}</h2>
      </button>
    </div>
  </div>
...
export default class ChannelContentComponent extends RootComponent {
  ...
  addFile (event: InputEvent) {
    this.content.file = this.mainConfig.$apis.file.getInputFile(event)
  }
